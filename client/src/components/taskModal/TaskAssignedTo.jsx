  ...
  return (
    <div className="space-y-2">
        ...
        <div className="space-y-1.5">
            ...
            <div 
                key={getUserKey(user, index)}
                className="flex items-center justify-between bg-slate-50 dark:bg-[#111215] border border-slate-200 dark:border-[#1C1F26] p-2 rounded-xl group hover:border-indigo-500/30 transition-all"
            >
                <div className="flex items-center gap-2">
                ...
                <button 
                onClick={() => toggleAssignee(user)}
                className="text-[10px] text-slate-450 dark:text-neutral-500 hover:text-rose-600 dark:hover:text-rose-400 opacity-0 group-hover:opacity-100 transition-opacity"
            ...
            className="w-full flex items-center justify-center gap-1.5 py-2 px-3 border border-dashed border-slate-250 dark:border-[#22242B] rounded-xl hover:border-indigo-500/40 text-[11px] text-slate-500 dark:text-neutral-400 hover:text-indigo-650 dark:hover:text-indigo-400 transition-all"
            >
